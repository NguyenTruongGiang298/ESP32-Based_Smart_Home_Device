...
static http_post_callback_t http_slider_callback=NULL;
static http_post_callback_t http_button_callback=NULL;
...
static esp_err_t post_handler(httpd_req_t *req)
{
    ...
    else if(strstr(req->uri,"button"))
        http_button_callback(buf,req->content_len);
    else if(strstr(req->uri,"pwm"))
        http_slider_callback(buf,req->content_len);
...
void http_set_callback_for_post(void * cb)
{
...
void http_set_callback_for_button(void * cb)
{
    http_button_callback = cb;
}
void http_set_callback_for_rgb(void * cb)
{
    http_rgb_callback = cb;
}
void http_set_callback_for_slider(void * cb)
{
    http_slider_callback = cb;
}
